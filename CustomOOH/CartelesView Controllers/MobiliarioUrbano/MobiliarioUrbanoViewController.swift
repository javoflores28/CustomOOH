//
//  MobiliarioUrbanoViewController.swift
//  CustomOOH
//
...
class MobiliarioUrbanoViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url: URL = URL(string: "http://martinmolina.com.mx/202111/equipo6/data/urbanos.json")!
    ...
    override func didReceiveMemoryWarning() {
        super.didReceiveMemoryWarning()
         ...
         func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell  {
           ...
           */
           ...
           let cell: MobiliarioUrbanoCollectionViewCell = collectionView.dequeueReusableCell(withReuseIdentifier: "cellUrbanos", for: indexPath) as! MobiliarioUrbanoCollectionViewCell
      ...
      func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
       ...
       let searchView: UICollectionReusableView = collectionView.dequeueReusableSupplementaryView(ofKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: "searchBarUrbanos", for: indexPath)
           return searchView
       }
